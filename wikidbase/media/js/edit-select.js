...
var EditableSelect = {
    ...
    "activate": function (select) {
        ...
        EditableSelect.addEvent(select, "change", EditableSelect.selectOnChange);
        EditableSelect.addEvent(select, "click", EditableSelect.selectOnChange);
